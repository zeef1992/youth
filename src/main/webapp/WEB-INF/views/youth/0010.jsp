...
<tiles:insertDefinition name="defaultTemplate">
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/youth/0010.css">
	<script src="${pageContext.request.contextPath}/resources/js/youth/0010.js" type="text/javascript"></script>
		<!-- HTML code -->
		<div id="right">
			<div class="header"></div>
			<div class="tab">
				<button class="tablinks active"
					onclick="openCity(event, '<spring:message code="title_signature_information_search" />')">
					<spring:message code="title_signature_information_search" />
				</button>
			</div>
			<div id="<spring:message code="title_signature_information_search" />"
				...
				<form class="form-horizontal">
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label class="control-label col-sm-4" for="signatureName"><spring:message code="signature_name" /></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id=signatureName placeholder="<spring:message code="signature_name" />">
					...
					<table class="table table-striped display-none" id="divHead">
						<thead>
								...
								<col width="40">
							<tr>
								<th class="align-center colr_53BBF4"><b><spring:message code="signature_id" /></b></th>
								<th class="align-center colr_53BBF4"><b><spring:message code="signature_name" /></b></th>
								<th></th>
								<th></th>
								<th></th>
							</tr>
			...
			<div id="popupWrapper" class="signatureinfo-popup">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span id = "update"><spring:message code="title_popup_signature_edit_information" /></span>
						<span id = "addNew"><spring:message code="title_popup_signature_add_information" /></span>
				...
				<div class="panel-body">
					<div class="col-sm-12">
						...
						<div class="col-sm-10">
							<div class="form-group">
								<label class="control-label col-sm-4" for="txtSignatureNamePopup"><spring:message code="signature_name" /></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="txtSignatureNamePopup" placeholder="<spring:message code="signature_name" />" />
									<input type="hidden" class="form-control" id="txtSignatureIdPopup" />
								</div>
							</div>
