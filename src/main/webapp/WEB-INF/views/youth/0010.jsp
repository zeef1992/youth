	...
	<script src="https://cdn.datatables.net/1.10.16/js/dataTables.bootstrap.min.js"></script>
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Quản Lý Chữ Ký<small>Control panel</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="${pageContext.request.contextPath}/main/"><i
							class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Quản Lý Chữ Ký</li>
				</ol>
			</section>
			<!-- Main content -->
										...
										<div class="box-body">
											...
											<table id="example2" class="table table-bordered table-hover">
												<thead>
													<tr>
														<th>STT</th>
														<th><b><spring:message code="signature_id" /></b></th>
														<th><b><spring:message code="signature_name" /></b></th>
														<th>Create By</th>
														<th>Update By</th>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Signature Information</h4>
					</div>
					<div class="modal-body">
						...
						<div class="box box-info">
							...
							<form class="form-horizontal">
								<div class="box-body">
									<div class="form-group">
										<label class="control-label col-sm-4" for="txtSignatureNamePopup"><spring:message
												code="signature_name" /></label>
										<div class="col-sm-6">
											<input type="text" class="form-control" id="txtSignatureNamePopup"
												placeholder="<spring:message code="signature_name" />" /> 
