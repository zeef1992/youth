		...
		<div id="right">
			...
			<div class="tab">
				<button class="tablinks active"
					onclick="openCity(event, '<spring:message code="title_wards_information_search" />')">
					<spring:message code="title_wards_information_search" />
				</button>
			</div>
			<div id="<spring:message code="title_wards_information_search" />" class="tabcontent" style="display: block;">
			<div class="panel-body">
				<form class="form-horizontal">
					...
					<span id="cityName"><spring:message code="city_name" />: <b id = "textCityName"></b></p>
