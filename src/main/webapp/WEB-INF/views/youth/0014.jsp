						...
						<div class="box-body">
							...
							<form class="form-horizontal">
								<div class="box-body">
									...
									<div class="col-sm-4">
										<div class="form-group">
											<label class="control-label col-sm-6" for="txtWardsCode"><spring:message code="city_code" /></label>
											<div class="col-sm-6">
												<input type="text" class="form-control" id="txtWardsCode" placeholder="<spring:message code="city_name" />">
											</div>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="form-group">
											<label class="control-label col-sm-6" for="txtWardsName"><spring:message code="city_name" /></label>
											<div class="col-sm-6">
												<input type="text" class="form-control" id="txtWardsName" placeholder="<spring:message code="city_name" />">
											</div>
										</div>
									</div>
								</div>
										...
										<div class="box-body">
											...
											<table id="example2" class="table table-bordered table-hover">
												<thead>
													<tr>
														<th>STT</th>
														<th><b><spring:message code="wards_code" /></b></th>
														<th><b><spring:message code="wards_name" /></b></th>
														<th>Create By</th>
														<th>Update By</th>
