		...
		<div id="right">
			...
			<div class="tab">
				<button class="tablinks active"
					onclick="openCity(event, '<spring:message code="title_district_information_search" />')">
					<spring:message code="title_district_information_search" />
				</button>
			</div>
			<div id="<spring:message code="title_district_information_search" />"
			...
			<div class="panel-body">
				<form class="form-horizontal">
					<div class="col-sm-12">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="control-label col-sm-6" for="txtCityCode"><spring:message code="district_code" /></label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="txtCityCode" placeholder="<spring:message code="district_code" />">
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label class="control-label col-sm-6" for="txtCityName"><spring:message code="district_name" /></label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="txtCityName" placeholder="<spring:message code="district_name" />">
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							<button id="btnSearch" class="btn btn-success align-center" type="button"><spring:message code="button_search" /></button>
						</div>
					</div>
					...
					<table class="table table-striped display-none" id = "divHead">
						<thead>
								...
								<col width="40">
							<tr>
								<th class="align-center colr_53BBF4"><b><spring:message code="district_code" /></b></th>
								<th class="align-center colr_53BBF4"><b><spring:message code="district_name" /></b></th>
								<th></th>
								<th></th>
							</tr>
						</thead>
			...
			<div id="popupWrapper" class="districtinfo-popup">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span id = "update"><spring:message code="title_popup_district_edit_information" /></span>
						<span id = "addNew"><spring:message code="title_popup_district_add_information" /></span>
