...
<tiles:insertDefinition name="defaultTemplate">
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/youth/0012.css">
	<script src="${pageContext.request.contextPath}/resources/js/youth/0012.js" type="text/javascript"></script>
		<!-- HTML code -->
		<div id="right">
			<div class="header"></div>
			<div class="tab">
				<button class="tablinks active"
					onclick="openCity(event, '<spring:message code="title_city_information_search" />')">
					<spring:message code="title_city_information_search" />
				</button>
			</div>
			<div id="<spring:message code="title_city_information_search" />"
			...
			<div class="panel-body">
				<form class="form-horizontal">
					<div class="col-sm-12">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="control-label col-sm-6" for="txtCityCode"><spring:message code="city_code" /></label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="txtCityCode" placeholder="<spring:message code="city_name" />">
								</div>
							</div>
						</div>
						<div class="col-sm-5">
							<div class="form-group">
								<label class="control-label col-sm-4" for="txtCityName"><spring:message code="city_name" /></label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="txtCityName" placeholder="<spring:message code="city_name" />">
								</div>
								<div class="col-sm-4">
					...
					<table class="table table-striped display-none" id = "divHead">
						<thead>
								...
								<col width="40">
							<tr>
								<th class="align-center colr_53BBF4"><b><spring:message code="city_code" /></b></th>
								<th class="align-center colr_53BBF4"><b><spring:message code="city_name" /></b></th>
								<th></th>
								<th></th>
							</tr>
						</thead>
			...
			<div id="popupWrapper" class="cityinfo-popup">
				...
				<div class="panel-body">
					<div class="col-sm-12">
						...
						<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="control-label col-sm-4" for="txtCityCodePopup"><spring:message code="city_code" /></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="txtCityCodePopup" placeholder="<spring:message code="city_code" />" />
								</div>
							</div>
							<div class = "clear height10"></div>
							<div class="form-group">
