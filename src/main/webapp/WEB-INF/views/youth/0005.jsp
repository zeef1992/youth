		...
		<div id="right">
			...
			<div class="tab">
				<button class="tablinks active"
					onclick="openCity(event, '<spring:message code="title_report_information_search" />')">
					<spring:message code="title_report_information_search" />
				</button>
			</div>
			<div id="<spring:message code="title_popup_user_information" />"
						...
						<div class="col-sm-12">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label class="control-label col-sm-4" for="reportName"><spring:message
											code="report_name" /></label>
									<div class="col-sm-8">
										<input type="text" class="form-control" id="reportName"
											placeholder="<spring:message code="report_name" />">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control"
											id="txtReportNamePopup"
											placeholder="<spring:message code="report_name" />" /> <input
											type="hidden" class="form-control" id="txtReportIdPopup" />
									</div>
								</div>
