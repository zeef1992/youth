...
<tiles:insertDefinition name="defaultTemplate">
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/youth/0009.css">
	<script src="${pageContext.request.contextPath}/resources/js/youth/0009.js" type="text/javascript"></script>
		<div id="right">
			<div class="header"></div>
			<div class="tab">
				<button class="tablinks active"
					onclick="openCity(event, '<spring:message code="title_category_information_search" />')">
					<spring:message code="title_category_information_search" />
				</button>
			</div>
			<div id="<spring:message code="title_category_information_search" />"
				...
				<div class="panel-body">
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label class="control-label col-sm-4" for="txtCateName"><spring:message code="cate_name" /></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="txtCateName" placeholder="<spring:message code="cate_name" />">
					...
					<table class="table table-striped display-none" id="divHead">
						<thead>
								...
								<col width="40">
							<tr>
								<th class="align-center colr_53BBF4"><b><spring:message code="cate_id" /></b></th>
								<th class="align-center colr_53BBF4"><b><spring:message code="cate_name" /></b></th>
								<th></th>
								<th></th>
								<th></th>
							</tr>
			...
			<div id="popupWrapper" class="cateinfo-popup">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span id = "update"><spring:message code="title_popup_category_edit_information" /></span>
				...
				<div class="panel-body">
					<div class="col-sm-12">
						...
						<div class="col-sm-10">
							<div class="form-group">
								<label class="control-label col-sm-4" for="txtCateNamePopup"><spring:message code="cate_name" /></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="txtCateNamePopup" placeholder="<spring:message code="cate_name" />" />
									<input type="hidden" class="form-control" id="txtCateIdPopup" />
								</div>
							</div>
							<div class="clear"></div>
