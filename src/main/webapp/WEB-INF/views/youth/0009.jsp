...
<tiles:insertDefinition name="defaultTemplate">
	<tiles:putAttribute name="body">
		<link rel="stylesheet"
			href="${pageContext.request.contextPath}/resources/css/youth/0009.css">
		<script
			src="${pageContext.request.contextPath}/resources/js/youth/0009.js"
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Phân loại thanh niên<small>Control panel</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="${pageContext.request.contextPath}/main/"><i
							class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Phân loại thanh niên</li>
				</ol>
			</section>
			<!-- Main content -->
							...
							<form class="form-horizontal">
								<div class="box-body">
									<div class="form-group">
										<label class="control-label col-sm-4" for="txtCateName"><spring:message
												code="cate_name" /></label>
										<div class="col-sm-4">
											<input type="text" class="form-control" id="txtCateName"
												placeholder="<spring:message code="cate_name" />">
										...
										<div class="box-body">
											...
											<table id="example2" class="table table-bordered table-hover">
												<thead>
													<tr>
														<th>STT</th>
														<th><b><spring:message code="cate_id" /></b></th>
														<th><b><spring:message code="cate_name" /></b></th>
														<th>Create By</th>
														<th>Update By</th>
					...
					<div class="modal-body">
						...
						<div class="box box-info">
							...
							<form class="form-horizontal">
								<div class="box-body">
									<div class="form-group">
										<label class="control-label col-sm-4" for="txtCateNamePopup"><spring:message
												code="cate_name" /></label>
										<div class="col-sm-6">
											<input type="text" class="form-control" id="txtCateNamePopup"
												placeholder="<spring:message code="cate_name" />" /> <input
												type="hidden" class="form-control" id="txtCateIdPopup" />
										</div>
									</div>
								</div>
								<!-- /.box-body -->
