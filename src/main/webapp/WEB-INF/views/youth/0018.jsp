		...
		<div id="right">
			...
			<div class="tab">
				<button class="tablinks active"
					onclick="openCity(event, '<spring:message code="title_university_information_search" />')">
					<spring:message code="title_university_information_search" />
				</button>
			</div>
			<div id="<spring:message code="title_university_information_search" />" class="tabcontent" style="display: block;">
			...
			<div id="popupWrapper" class="universityinfo-popup">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span id = "update"><spring:message code="title_popup_university_edit_information" /></span>
						<span id = "addNew"><spring:message code="title_popup_university_add_information" /></span>
				...
				<div class="panel-body">
					<div class="col-sm-12">
						...
						<div class="col-sm-10">
							...
							<div class="clear height10"></div>
							<div class="form-group ">
								<label class="control-label col-sm-4" for="txtUniversityNamePopup"></label>
								<div class="col-sm-8">
