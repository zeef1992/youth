...
<tiles:insertDefinition name="defaultTemplate">
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/youth/0016.css">
	<script src="${pageContext.request.contextPath}/resources/js/youth/0016.js" type="text/javascript"></script>
		<!-- HTML code -->
		<div id="right">
			<div class="header"></div>
			<div class="tab">
				<button class="tablinks active"
					onclick="openCity(event, '<spring:message code="title_groups_information_search" />')">
					<spring:message code="title_groups_information_search" />
				</button>
			</div>
			<div id="<spring:message code="title_groups_information_search" />" class="tabcontent" style="display: block;">
			<div class="panel-body">
				<form class="form-horizontal">
					<div class="col-sm-12">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="control-label col-sm-6" for="cbbTown"><spring:message code="town_name" /></label>
								<div class="col-sm-6">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="control-label col-sm-6" for="txtGroupsCode"><spring:message code="groups_code" /></label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="txtGroupsCode" placeholder="<spring:message code="groups_code" />">
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								<label class="control-label col-sm-6" for="txtGroupsName"><spring:message code="groups_name" /></label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="txtGroupsName" placeholder="<spring:message code="groups_name" />">
								</div>
							</div>
						</div>
						<div class="col-sm-4">
					...
					<input type="hidden" id = "townIdDefault" value = "${townIdDefault}" />
					...
					<span id="townName"><spring:message code="wards_name" />: <b id = "textTownName"></b></span>
					<table class="table table-striped display-none" id = "divHead">
						<thead>
								...
								<col width="40">
							<tr>
								<th class="align-center colr_53BBF4"><b><spring:message code="groups_code" /></b></th>
								<th class="align-center colr_53BBF4"><b><spring:message code="groups_name" /></b></th>
								<th></th>
								<th></th>
							</tr>
						</thead>
			...
			<div id="popupWrapper" class="groupsinfo-popup">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span id = "update"><spring:message code="title_popup_groups_edit_information" /></span>
						<span id = "addNew"><spring:message code="title_popup_groups_add_information" /></span>
				...
				<div class="panel-body">
					<div class="col-sm-12">
						...
						<div class="col-sm-10">
							...
							<div class = "clear height10"></div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="txtGroupsCodePopup"><spring:message code="groups_code" /></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="txtGroupsCodePopup" placeholder="<spring:message code="groups_code" />" />
								</div>
							</div>
							<div class = "clear height10"></div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="txtGroupsNamePopup"><spring:message code="groups_name" /></label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="txtGroupsNamePopup" placeholder="<spring:message code="groups_name" />" />
									<input type="hidden" class="form-control" id="txtGroupsIdPopup" />
								</div>
							</div>
							<div class="clear height10"></div>
							<div class="form-group ">
