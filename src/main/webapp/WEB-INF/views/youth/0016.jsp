...
<tiles:insertDefinition name="defaultTemplate">
	...
	<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Quản Lý Tổ Dân Phố<small>Control panel</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="${pageContext.request.contextPath}/main/"><i
							class="fa fa-dashboard"></i> Home</a></li>
					<li class="active">Quản Lý Tổ Dân Phố</li>
				</ol>
			</section>
			<!-- Main content -->
										...
										<div class="box-body">
											...
											<table id="example2" class="table table-bordered table-hover">
												<thead>
													<tr>
														<th>STT</th>
														<th><b><spring:message code="groups_code" /></b></th>
														<th><b><spring:message code="groups_name" /></b></th>
														<th>Create By</th>
														<th>Update By</th>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Groups Information</h4>
					</div>
