		...
		<div id="right">
			...
			<div class="tab">
				<button class="tablinks active"
					onclick="openCity(event, '<spring:message code="title_country_information_search" />')">
					<spring:message code="title_country_information_search" />
				</button>
			</div>
			<div id="<spring:message code="title_country_information_search" />"
				...
				<form class="form-horizontal">
					<div class="col-sm-12">
						<div class="col-sm-5">
							<div class="form-group">
								<label class="control-label col-sm-4" for="txtCountryCode"><spring:message code="country_code" /></label>
								<div class="col-sm-8">
						...
						<div class="col-sm-5">
							<div class="form-group">
								<label class="control-label col-sm-4" for="txtCountryName"><spring:message code="country_name" /></label>
								<div class="col-sm-8">
					...
					<table class="table table-striped display-none" id = "divHead">
						<thead>
								...
								<col width="40">
							<tr>
								<th class="align-center colr_53BBF4"><b><spring:message code="country_code" /></b></th>
								<th class="align-center colr_53BBF4"><b><spring:message code="country_name" /></b></th>
								<th></th>
								<th></th>
							</tr>
						</thead>
			...
			<div id="popupWrapper" class="countryinfo-popup">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span id = "update"><spring:message code="title_popup_country_edit_information" /></span>
						<span id = "addNew"><spring:message code="title_popup_country_add_information" /></span>
				...
				<div class="panel-body">
					<div class="col-sm-12">
						...
						<div class="col-sm-10">
							...
							<div class="clear height10"></div>
							<div class="form-group ">
								<label class="control-label col-sm-4" for="txtCountryNamePopup"></label>
								<div class="col-sm-8">
