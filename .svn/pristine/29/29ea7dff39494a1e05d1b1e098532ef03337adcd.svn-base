...
private static Logger logger = Logger.getLogger(Sym0003Service.class);
	...
	public void initData(Model model, String reportId) {
		...
		try {
			reportData = sym0025Dao.getQltnMReportMapper().selectByExample(null);
		...
		model.addAttribute("reportIdDefault", "");
	}
    /**
    ...
    private HashMap<String, Object> createSearchConditionParams(Sym0025Conditions searchConditions) {
        ...
        // report Name
        params.put("detailReportId", searchConditions.getDetailReportId());
        // report Name
	...
	public List<QltnMDetailReport> getDetailReportNameByReportId(String reportId) {
		// Combobox detail Data
		...
		QltnMDetailReportExample.Criteria  detailReportCriteria = QltnMDetailReportExample.createCriteria();
		detailReportCriteria.andReportIdEqualTo(reportId);
	
		detailReportCriteria.andDeleteFlagEqualTo(Constants.DELETE_FLAG_OFF);
		detailReportData = sym0025Dao.getQltnMDetailReportMapper().selectByExample(QltnMDetailReportExample);
