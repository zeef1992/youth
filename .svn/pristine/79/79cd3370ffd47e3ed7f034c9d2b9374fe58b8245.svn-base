...
var rootPath = "http://localhost:8080/youth/";
...
function setDefaultforTable() {
	// get all the necessary height of controls
	var windowHeight = $(window).height();
	var headerHeight = $("header").height();
	var titleHeight = $(".panel-default").height();
	var searchConditionHeight = $(".panel-body").height();
	// calculate table body height
	return windowHeight - headerHeight - titleHeight - searchConditionHeight -125;
}
...
function hidePopupMain(element) {
	element.hide();
}
